...
>(({ className, ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track className="bg-neutral-600 hover:cursor-pointer relative h-[3px] grow rounded-full group flex items-center transition">
        <SliderPrimitive.Range className="absolute bg-white transition special h-full rounded-full" />
